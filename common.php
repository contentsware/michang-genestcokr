...
$menu = array(
    array(
        'title' => '회사소개'
        , 'title_eng' => 'About Genest'
        , 'url' => '/intro/company.php'
        , 'submenu' => array(
            array('title' => '회사소개' , 'title_eng' => 'About Genest' , 'url' => '/intro/company.php')
            , array('title' => '인사말' , 'title_eng' => 'Message' , 'url' => '/intro/message.php')
            , array('title' => '연혁' , 'title_eng' => 'Company History' , 'url' => '/intro/history.php')
            , array('title' => '조직도' , 'title_eng' => 'Organization' , 'url' => '/intro/organization.php')
            , array('title' => '인증현황' , 'title_eng' => 'Certification' , 'url' => '/bbs/board.php?bo_table=cert' , 'bo_table' => 'cert')
            , array('title' => '오시는길' , 'title_eng' => 'Location' , 'url' => '/intro/location.php')
        )
    )
    , array(
        'title' => '생산품'
        , 'title_eng' => 'Products'
        , 'url' => '/product/medical.php'
        , 'submenu' => array(
            array('title' => '의료기기제품' , 'title_eng' => 'Medical Products' , 'url' => '/product/medical.php')
            , array('title' => '방위산업제품' , 'title_eng' => 'Defense Products' , 'url' => '/product/defense.php')
            , array('title' => '기타 산업 부품' , 'title_eng' => 'Other Industrial parts' , 'url' => '/product/other.php')
        )
    )
    , array(
        'title' => '보유설비'
        , 'title_eng' => 'Equipment'
        , 'url' => '/bbs/board.php?bo_table=production'
        , 'submenu' => array(
            array('title' => '생산설비' , 'title_eng' => 'Production Equipment' , 'url' => '/bbs/board.php?bo_table=production' , 'bo_table' => 'production')
            , array('title' => '검사설비' , 'title_eng' => 'Inspection Equipment' , 'url' => '/bbs/board.php?bo_table=inspection' , 'bo_table' => 'inspection')
        )
    )
    , array(
        'title' => '고객센터'
        , 'title_eng' => 'Customer Center'
        , 'url' => '/bbs/board.php?bo_table=notice'
        , 'submenu' => array(
            array('title' => '공지사항' , 'title_eng' => 'Notice' , 'url' => '/bbs/board.php?bo_table=notice' , 'bo_table' => 'notice')
            , array('title' => '자유게시판' , 'title_eng' => 'Community' , 'url' => '/bbs/board.php?bo_table=free' , 'bo_table' => 'free')
            , array('title' => '온라인문의' , 'title_eng' => 'Contact Us' , 'url' => '/bbs/write.php?bo_table=req' , 'bo_table' => 'req')
        )
    )
    , array(
        'title' => '사내게시판'
        , 'title_eng' => 'Member Community'
        , 'url' => '/bbs/board.php?bo_table=mng_dept'
        , 'submenu' => array(
            array('title' => '관리부' , 'title_eng' => 'Management Department' , 'url' => '/bbs/board.php?bo_table=mng_dept' , 'bo_table' => 'mng_dept')
            , array('title' => '생산부' , 'title_eng' => 'Production Department' , 'url' => '/bbs/board.php?bo_table=prdt_dept' , 'bo_table' => 'prdt_dept')
            , array('title' => '품질관리부' , 'title_eng' => 'Quality Management Department ' , 'url' => '/bbs/board.php?bo_table=qm_dept' , 'bo_table' => 'qm_dept')
        )
    )
);
?>