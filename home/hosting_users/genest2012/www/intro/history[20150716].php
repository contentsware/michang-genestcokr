            ...
            <ul class="ul_history">
                ...
                <li>
                    <ul class="ul_history" style="margin-bottom:30px!important;">
                        ...
                        <li class="content">
                            <div class="m-t-5 m-b-10"><span class="txt01">03</span> 무게중심의 조절이 가능한 베럴 특허등록</div>
                    ...
                    <ul class="ul_history border-top">
                        ...
                        <li class="content">
                            ...
                            <div class="m-b-10"><span class="txt01">01</span> 제네스트 법인 전환</div>
                            <div class="m-b-30"><span class="txt01">01</span> 의료기기 제조업 허가</div>
                        </li>
                    </ul>
                    <ul class="ul_history border-top">
