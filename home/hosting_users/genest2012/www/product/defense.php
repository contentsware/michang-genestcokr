    ...
    <div class="content_area">
        ...
        <div class="sub_content">
            <div class="text-center">
                <div><img src="/img/product/defense01.png"></div>
                <div class="product_txt01 m-t-20">Defense Products</div>
                <div class="product_txt02 m-t-10">방위산업제품</div>
                <div class="product_txt03 m-t-20">Titanium, SUS 등의 소재를 이용한 방위산업 부품 정밀 가공</div>
            </div>
            <div class="m-t-30"><img src="/img/product/defense02.png"></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
