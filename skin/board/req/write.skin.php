...
<div class="wrap_content">
    ...
    <div class="content_area">
        <ul class="sub_nav">
            ...
            <li class="img">
                <img src="/img/customer/sub_top.png">
            </li>
        </ul>
        <div class="clear"></div>
        <div class="sub_content">
            <section id="bo_w">
                ...
                <div class="tbl_frm01 tbl_wrap">
                    ...
                    <tr>
                        <th scope="row"><label for="wr_1">상호<strong class="sound_only">필수</strong></label></th>
                        <td><input type="text" name="wr_1" value="<?=$view['wr_1']?>" id="wr_1" required class="frm_input required" size="30" maxlength="100"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="wr_2" value="<?=$view['wr_2']?>" id="wr_2" required class="frm_input required" size="30" maxlength="100"></td>
                    </tr>
