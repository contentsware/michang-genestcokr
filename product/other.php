    ...
    <div class="content_area">
        ...
        <div class="sub_content">
            <div class="text-center">
                <div><img src="/img/product/other01.png"></div>
                <div class="product_txt01 m-t-20">Other Industrial parts</div>
                <div class="product_txt02 m-t-10">기타 산업 부품</div>
                <div class="product_txt03 m-t-20">Aluminium, Beryllium, 황동 등의 소재를 이용한 반도체 외 다양한 산업 분야의 정밀 가공</div>
            </div>
            <div class="m-t-30"><img src="/img/product/other02.png"></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
